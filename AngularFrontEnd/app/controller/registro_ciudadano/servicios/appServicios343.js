                ...
                if (feature) {
                    ...
                    reqwest({
                        ...
                        for (var i = 0; i < n_genesis; i++) {
                            if (geo_id_sit_servicio[i] === cod_zona_sit) {
                        ...
                        $q.all(listarZonas).then(function (resp) {
                            ...
                            reqwest({
                                ...
                                ///////////////////////////
                                var aux = $('#f01_zona_act_descrip').val();
                                if (aux == '') {
                                    swal('', "No se encontro la zona, por favor seleccione en el combo Zona", 'warning');
                                }
                                ///////////////////////////
        ...
        $scope.btnEnviarFormPermisos = true; swal('Señor ciudadano', 'Complete los datos del formulario para enviar su solicitud');
            ...
            if ($scope.PERMISO != "D")
                ...
                $scope.btnEnviarFormPermisos = true; swal('Señor ciudadano', 'Complete los datos del formulario para enviar su solicitud');
                    ...
                    swal('Señor ciudadano', 'Complete los datos del formulario para enviar su solicitud');
