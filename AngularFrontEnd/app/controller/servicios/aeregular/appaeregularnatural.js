app.controller('regularController', function ($scope,$timeout, $q, $rootScope, $routeParams, $location, $http, Data, sessionService,CONFIG, LogGuardarInfo, $element, sweet, registroLog, filterFilter,FileUploader,ngTableParams, $filter, fileUpload,wsRgistrarPubliciadad, $window) {
    var fecha= new Date();
 ...
 ///TERMINA LICENCIA MULTIPLE
    ...
    var clsInicioInternet = $rootScope.$on('inicioInternetRc', function(event, data){
        //$scope.datos.f01_tipo_per_VALOR = 'NATURAL';
    ...
    var clsIniciarCamposInternet = $rootScope.$on('inicializarCamposInternet', function(event, data){
        ...
        if(typeof(data.f01_tipo_lic) != 'undefined'){
            //$scope.getCategorias(data.f01_tipo_lic);
    ...
    setTimeout(function(){
        ...
        console.log("$rootScope.laaa: ", $scope.datos.INT_AC_latitud, " :: ", $scope.datos.INT_AC_longitud);

        $scope.nom_via = data.f01_nom_via_prop;
   ...
   $scope.cambioToggleForm = function (cambio) {
    ...
    $scope.actualizaVia = function(){
        document.getElementById('f01_zona_act_descrip'). value = "";
    }
   ...
   /*VERIFICANDO CAMPOS OBLIGATORIOS*/
    ...
    $scope.enviarFormProcesosLinea = function(paramForm){
        ...
        if ($scope.tipoPersona == 'NATURAL'){
            ...
            datosNeXO['f01_nac_prop']=paramForm.INT_NACIONALIDAD;
            datosNeXO['f01_fecha_nac']=paramForm.f01_fecha_nac;
            datosNeXO['f01_telef_prop']=paramForm.f01_tel_ciudadano;
            datosNeXO['f01_cel_prop']=paramForm.f01_cel_prop;
            datosNeXO['f01_email_prop']=paramForm.f01_email_prop;
            //DIRECCION DEL CONTRIBUYENTE
            datosNeXO['f01_zon_prop_desc']=paramForm.f01_zon_prop_valor;
            datosNeXO['f01_zon_prop']=paramForm.f01_zona;//paramForm.INT_ID_ZONA;
            datosNeXO['f01_tip_via_prop_desc']=paramForm.f01_tip_via_prop;
            datosNeXO['f01_tip_via_prop']=paramForm.f01_tip_via_prop;
            datosNeXO['f01_nom_via_prop']= paramForm.f01_nom_via_prop;
            datosNeXO['f01_num_prop']=paramForm.f01_num_prop;
            datosNeXO['f01_nom_edi_prop']=paramForm.INT_EDIF;
            ...
            datosNeXO['f01_categoria_agrupada']= parseInt(paramForm.f01_categoria_agrupada);//paramForm.f01_categoria_descrip;
        ...
        //datosNeXO['INT_ID_CAT_AGRUPADA']=10;
