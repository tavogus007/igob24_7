    ...
    angular.module('mwl.calendar').factory('calendarTitle', [
        ...
        function (moment, calendarConfig, calendarHelper) {
            function day(currentDay) {
                ...
                var sCadena = calendarHelper.formatDate(currentDay, calendarConfig.titleFormats.day);
                //ES - reemplazar la forma de hacer los reemplazos
                sCadena = sCadena.replace("January","Enero");
                sCadena = sCadena.replace("February","Febrero");
                sCadena = sCadena.replace("March","Marzo");
                sCadena = sCadena.replace("April","Abril");
                sCadena = sCadena.replace("May","Mayo");
                sCadena = sCadena.replace("June","Junio");
                sCadena = sCadena.replace("July","Julio");
                sCadena = sCadena.replace("August","Agosto");
                sCadena = sCadena.replace("September","Septiembre");
                sCadena = sCadena.replace("October","Octubre");
                sCadena = sCadena.replace("November","Noviembre");
                sCadena = sCadena.replace("December","Diciembre");
                //ES - dias de la semana                
                sCadena = sCadena.replace("Monday","Lunes");
                sCadena = sCadena.replace("Tuesday","Martes");
                sCadena = sCadena.replace("Wednesday","Miercoles");
                sCadena = sCadena.replace("Thursday","Jueves");
                sCadena = sCadena.replace("Friday","Viernes");
                sCadena = sCadena.replace("Saturday","Sábado");
                sCadena = sCadena.replace("Sunday","Domingo");
            ...
            function week(currentDay) {
                ...
                //ES - Remplazando las fechas de la semana
                weekTitleLabel = weekTitleLabel.replace("Week","Semana");
                weekTitleLabel = weekTitleLabel.replace("of","de");
            ...
            function month(currentDay) {
                //ES - meses del año
                var sCadena = calendarHelper.formatDate(currentDay, calendarConfig.titleFormats.month);
                //ES - reemplazar la forma de hacer los reemplazos
                sCadena = sCadena.replace("January","Enero");
                sCadena = sCadena.replace("February","Febrero");
                sCadena = sCadena.replace("March","Marzo");
    ...
    angular.module('mwl.calendar').factory('calendarHelper', [
        ...
        function (dateFilter, moment, calendarConfig) {
            ...
            function getWeekDayNames() {
                ...
                var count = 0;
                while (count < 7) {
                    weekdays.push(formatDate(moment().weekday(count++), calendarConfig.dateFormats.weekDay));//dias de la semana
                }
                //Cambiando dias de la semana al español
                weekdays[0] = "Domingo";
                weekdays[1] = "Lunes";
                weekdays[2] = "Martes";
            ...
            function getYearView(events, currentDay) {
                ...
                while (count < 12) {
                    ...
                    var periodEvents = filterEventsInPeriod(eventsInPeriod, startPeriod, endPeriod);//meses del año
                    //Meses año en español
                    var mes = formatDate(startPeriod, calendarConfig.dateFormats.month).toString();
                    var aux="";
                    switch (mes) {
                        case "January": aux="Enero"; break;
                        case "February": aux="Febrero"; break;
                        case "March": aux="Marzo"; break;
                        case "April": aux="Abril"; break;
                        case "May": aux="Mayo"; break;
                        case "June": aux="Junio"; break;
                        case "July": aux="Julio"; break;
                        case "August": aux="Agosto"; break;
                        case "September": aux="Septiembre"; break;
                        case "October": aux="Octubre"; break;
                        case "November": aux="Noviembre"; break;
                        case "December": aux="Diciembre"; break;
                        default: aux="Error";
                    }
                    //formatDate(startPeriod, calendarConfig.dateFormats.month),
                    view.push({
                        label: aux,
            ...
            function getWeekView(events, currentDay) {
                ...
                while (days.length < 7) {
                    ...
                    //formatDate(dayCounter, calendarConfig.dateFormats.weekDay)
                    var dia = formatDate(dayCounter, calendarConfig.dateFormats.weekDay).toString();
                    var aux="";
                    switch (dia) {                            
                        case "Sunday": aux="Domingo"; break;
                        case "Monday": aux="Lunes"; break;
                        case "Tuesday": aux="Martes"; break;
                        case "Wednesday": aux="Miercoles"; break;
                        case "Thursday": aux="Jueves"; break;
                        case "Friday": aux="Viernes"; break;
                        case "Saturday": aux="Sábado"; break;
                        default: aux="Error";
                    }
                    days.push({
                        weekDayLabel: aux,
            ...
            var refreshCalendar = calendarDebounce(function () {
                ...
                try{                
                    $scope.events = $scope.events.map(function (event, index) {
                        ...
                        }catch(e){}// --> REVISAR, se produce un error
                        return event;
                    });
                }catch(e){}                    
