...
angular
  ...
  app.controller('MainCtrl', function ($scope, $modal, moment) {
    ...
    $scope.events = [
      {
        title: 'Taller de capacitacion "Crear tramites en linea"',
        type: 'warning',
        //startsAt: moment().startOf('day').subtract(2, 'days').add(8, 'hours').toDate(),
        startsAt: 'Fri Jun 26 2015 08:00:00 GMT-0400',
