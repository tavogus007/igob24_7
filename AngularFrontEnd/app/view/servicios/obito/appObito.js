...
function obitoController($scope,$timeout, $rootScope, $routeParams, $location, $http, Data, sessionService,CONFIG, LogGuardarInfo, $element, sweet, registroLog, filterFilter,FileUploader,ngTableParams, $filter, fileUpload,wsRgistrarPubliciadad, $window, wsObito) {
    ...
    ////////////////////////////////////////////////////////////////////  
    $scope.enviarFormProcesosObito = function(dato){
        $.blockUI({ css: { 
                    border: 'none', 
                    padding: '10px', 
...
                },message: "Espere un momento por favor ..." }); 
        setTimeout(function(){
            ...
            var settings = {
              "async": true,
              "crossDomain": true,
              "url": CONFIG.CONEXION_API_PG_IF_OFICIAL + "wsSOAP/registroSolicitudObito",
            ...
            $.ajax(settings).done(function (response) {
                ...
                console.log('dataRespAe   ',dataRespAe);
                ...
                if (nroTramiteEnviado.length > 0) {
                     ...
                     sdatos.llamarregla(function(results){
                        ...
                        if (results == '[]' || results == '[{}]' || results == '[{ }]' || results == ' ' || results == '') {
                            ...
                            if (results == true) {
                                ...
                                swal("Nro de Proforma creado", "Señor Ciudadano realice el pago con la siguiente proforma : " + nroTramiteEnviado);
                                $.unblockUI();
                            }else{
                    ...
                    swal('', 'No se envio el trámite', 'error');
                $.unblockUI();
                }
