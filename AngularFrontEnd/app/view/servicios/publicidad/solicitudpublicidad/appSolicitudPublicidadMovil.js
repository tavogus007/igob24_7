...
function obtenerCategorias(input) {
  $http.post(CONFIG.CONEXION_API_PG_IF+'wsGENESIS/buscarCategoriaPublicidad', { categoria: 'Movil' })
...
//********************************* */
  $scope.validarCamposLlenos = function () {
    for (var i = 0; i < $scope.inputs.length; i++) {
      ...
      if (
        !input.categoria || !input.idTipoLetrero || !input.marca || !input.placa || !input.superficie) {          
