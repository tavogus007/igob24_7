            ...
            var det = [
                {
                    ...
                    "odm_pre_unitario": $scope.datosIntermedio.vitm_monto, 
                    "odm_cantidad": 1, 
                    "odm_sub_total": $scope.datosIntermedio.vitm_monto
                }
            ];
            var formData = {
                ...
                "monto_total": $scope.datosIntermedio.vitm_monto,
                "detalles": det,
                "data": {
                ...
                headers: {
                    ...
                    if(dataIN.success.code == 200){
                        ...
                        var ficha = $scope.codigo_ficha.split('-');
                                    var formDataPago = {
                                        "odm": $scope.nroOdm,
                                        "total": $scope.datosIntermedio.vitm_monto,
                                        ...
                                        //"usuario_fac": $scope.datosHospital.vhsp_usuario,
                                        //"clave_fac": $scope.datosHospital.vhsp_contrasenia, 
                                        "nit_factura": ci_nit,
                                        ...
                                        "data_opcional":[
                                            {
                                                ...
                                                //"codigo_generado": $scope.codigoFactura,
                                                "tipoPago":"TARJETA"
                                            }
                                        ],
                                        "items":[
                                            {
                                                ...
                                                "cantidad": 1,
                                                "precio_unitario": $scope.datosIntermedio.vitm_monto,
                                                "cod_Item_recaudador": $scope.datosIntermedio.vitm_cod_item ,
                                                "monto_descuento": 0.00,
                                                "subtotal": $scope.datosIntermedio.vitm_monto,
    ...
    $scope.pagoOnlineQR = function(){
      procesando();
        if($scope.datosPaciente.dtspsl_correo == '' || $scope.datosPaciente.dtspsl_correo == null || $scope.datosPaciente.dtspsl_correo == undefined){
            ...
            var formData = '{"Tipo": "generarOdm","razon_social": "'+$scope.datosPaciente.dtspsl_paterno+'","ci_nit": "'+$scope.datosPaciente.dtspsl_ci+'","unidad_recaudadora": "'+$scope.datosIntermedio.vitm_cod_ur+'","sucursal": "'+$scope.datosIntermedio.vitm_sucursal+'","monto_total": "'+$scope.datosIntermedio.vitm_monto+'","detalles": [{    "odm_item_recaudador": "'+$scope.datosIntermedio.vitm_cod_item+'",    "odm_pre_unitario": "'+$scope.datosIntermedio.vitm_monto+'",    "odm_cantidad": "1",    "odm_sub_total": "'+$scope.datosIntermedio.vitm_monto+'"  }],"data": [{}]}';
            $.ajax({
                type        : 'POST',
                url         : urlODM,
                data        : formData,
                ...
                headers: {
                  'Content-Type': 'application/json',
                    ...
                    try{
                        var sql = new dataDinamic();
                        sql.consulta = 'SELECT * from facturacion.sp_insertar_controlador('+$scope.idHospital+','+$scope.datosPacienteSalud[0].idpersona+',1)';
                        sql.SqlDinamic(function(res){
                            var x = JSON.parse(res);
                            var resultado = x.success.data;
                            if (resultado[0].sp_dinamico != null)
        ...
        if(datosFact.correo == '' || datosFact.correo == null || datosFact.correo == undefined){
            alertify.error('Para utilizar nuestro servicio de Pago en linea necesitamos su correo electrónico.');
             ...
             var det = [
                 {
                     "odm_item_recaudador": $scope.datosIntermedio.vitm_cod_item, 
                     "odm_pre_unitario": 0.10,//$scope.datosIntermedio.vitm_monto, 
                     "odm_cantidad": 1, 
                     "odm_sub_total": 0.10//$scope.datosIntermedio.vitm_monto
                 }
             ];
             var formData = {
                 "razon_social": datosFact.razon_social,
                 ...
                 "unidad_recaudadora": $scope.datosIntermedio.vitm_cod_ur,
                 "sucursal": $scope.datosIntermedio.vitm_sucursal,
                 "monto_total": 0.10,//$scope.datosIntermedio.vitm_monto,
                 "detalles": det,
                 "data": {
                   "gestion_pago": $scope.datosIntermedio.vanio
                 }
             ...
             $.ajax({
                 ...
                 headers: {
                     ...
                     if(dataIN.success.code == 200){
                        ...
                        var formDataPago = {
                            "odm": $scope.nroOdm,
                            "total": 0.10,//$scope.datosIntermedio.vitm_monto,
                            "nombres": $scope.datosPaciente.dtspsl_nombres,
                            "apellidos": $scope.datosPaciente.dtspsl_paterno+' '+$scope.datosPaciente.dtspsl_materno,
                            "direccion": $scope.datosPaciente.dtspsl_direccion,
                            "email": datosFact.correo,
                            ...
                            "items":[
                                {
                                    "concepto": $scope.datosIntermedio.vitm_desc_item ,
                                    "cantidad": 1,
                                    "precio_unitario": 0.10, //$scope.datosIntermedio.vitm_monto,
                                    "cod_Item_recaudador": $scope.datosIntermedio.vitm_cod_item ,
                                    "monto_descuento": 0.00,
                                    "subtotal": 0.10, //$scope.datosIntermedio.vitm_monto,
                                    "id_item": $scope.datosIntermedio.vitm_siat
                                }
                            ]
                        };
    ...
    $scope.envioHojaReferencia = function (fecha) {
        ...
        try{
            ...
            sql.SqlDinamic(function(res){
                ...
                if (resultado[0].sp_dinamico != null)
                {
                    alertify.success('Envio exitoso. Recordarle de pasar por admisiones del hospital y llevar su hoja de referencia para su validación. \n\n Gracias por usar nuestro servicio.');
                    $.LoadingOverlay("hide");
                    $scope.mensajeReferencia = 'Envio exitoso. \n\n Estimado Ciudadano Recordarle la validación de su hoja de referencia lo pobra ver en el Historial de atenciones. \n\n En caso de rechazo podra verlo en su bandeja de rechazos que esta al lado de el Historial de Atenciones \n\n Gracias por usar nuestro servicio.';
