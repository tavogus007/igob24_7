function DenunciaController($scope, $rootScope, $routeParams, $location, $http, Data, sessionService,CONFIG, LogGuardarInfo, $element, sweet, ngTableParams, $filter, registroLog, filterFilter,FileUploader, fileUpload, $timeout, obtFechaCorrecta,$route, obtFechaActual,fileUpload1) {
    ...
    $scope.tiposTramite = [
      { detalle: 'Denuncia Operador de Radio Taxi', id:52 ,tipo:$scope.tipo_persona},
      { detalle: 'Denuncia Al Conductor', id:56 ,tipo:$scope.tipo_persona}
    ];
    $scope.datos = {};
    $scope.tablaTramites        =   {};
    ...
    [ { name: 'template0.html', url: '../../../app/index.html'},
      { name: 'template1.html', url: '../../../app/view/servicios/varios/formularios/movilidad/denuncias/denunciaOperadorRadioTaxi/denunciaOperadorRadioTaxi.html'},
    ...
    $scope.tramitesCiudadano = function(){
      ...
      tramites.descripcion="MOVILIDAD_DENUNCIAS";
    ...
    $scope.tramiteRender = function (tramite) {
      ...
      if($scope.procesoSeleccionado == $scope.denunciaAlConductor){
        idTemplate = 2;
      } 
