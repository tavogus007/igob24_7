function solicitudDeleveryController($scope, $rootScope, $routeParams, $location, $http, Data, sessionService,CONFIG, LogGuardarInfo, $element, sweet, ngTableParams, $filter, registroLog, filterFilter,FileUploader, fileUpload, $timeout, obtFechaCorrecta,$route, obtFechaActual,fileUpload1) {
    var sIdCiudadano= sessionService.get('IDSOLICITANTE');
    $scope.tipo_persona=sessionService.get('TIPO_PERSONA');
    $scope.oidCiu = sessionService.get('IDSOLICITANTE');
    $scope.tiposTramite = [
        { detalle: 'Solicitud de registro transitorio delivery', id:'25',tipo:$scope.tipo_persona}
    ];
    $scope.datos = {};
    $scope.tablaTramites        =   {};
    ...
    $scope.templates =
    [ 
      { name: 'template1.html', url: '../../../app/view/servicios/varios/formularios/movilidad/solicitudDelevery/permisoDelevery/permisoDelevery.html'}
    ];
