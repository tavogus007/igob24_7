  ...
  function cargando(){
    ...
    $scope.calcularfecha_entrada = function(fec){
      if ($scope.datos.TER_FEC_FIN != undefined) {
        ...
        if ($scope.cal_edad_mayor != 0) {
          //swal("La fecha de nacimiento es incorrectacccccc", 'este registro tiene que ser de una persona mayor de edad', "warning");
        }else {
          //sweet.show('', "Fecha incorrecta selecciones la fecha de retorno", 'warning');
          //swal("", 'Fecha incorrecta selecciones la fecha de retorno', "warning");
    ...
    $scope.calcularfecha_salida = function(fec){
      if ($scope.datos.TER_FEC_RET == undefined) {
        //sweet.show('', "Seleccione la fecha de salida primero", 'warning');
    ...
    $scope.llamar_data_ciudadano = function(){
      ...
      /*try{
        ...
        natural.ci = sessionService.get('CICIUDADANO');
        natural.buscarNatural(function(res){
          var x = JSON.parse(res);
          $scope.datos.DEF_INSTANCIAS = "UDIF_T";
          $scope.datos.G_CI = x[0].dtspsl_ci;
          $scope.datos.G_NNA_MAT = x[0].dtspsl_materno;
          $scope.datos.G_NNA_NOM = x[0].dtspsl_nombres;
          $scope.datos.G_NNA_PAT = x[0].dtspsl_paterno;
          $scope.datos.g_fecha = g_fecha;
        });
      }catch(e){
      }*/
    ...
    $scope.dit_zonas = function  (idMacro){
     ...
     /*$scope.evalScriptSalida = function(imagen) {
       var deferred = $q.defer();
       $scope.exito = "SI";
       try{
    ...
    $scope.guardar_tramite = function(datos){
      ...
      //var ternna_viajan.unshift(titulosnna);
      ...
      for (var i = 0; i < $scope.grid_n.length; i++) {
        ...
        /*datos.TER_NNA_VIAJAN.push({
          f01_NNA_TIP_DOC_valor: $scope.grid_n[i].f01_NNA_TIP_DOC_valor,
          f01_NNA_DIR: $scope.grid_n[i].f01_NNA_DIR,
          f01_NNA_EXP_CIUD_valor: $scope.grid_n[i].f01_NNA_EXP_CIUD_valor,
          f01_NNA_EXP_CIUD: $scope.grid_n[i].f01_NNA_EXP_CIUD,
          f01_NNA_F_CADUC_CI: $scope.grid_n[i].f01_NNA_F_CADUC_CI,
          f01_NNA_G_AMAT: $scope.grid_n[i].f01_NNA_G_AMAT,
          f01_NNA_G_APAT: $scope.grid_n[i].f01_NNA_G_APAT,
          f01_NNA_G_CI: $scope.grid_n[i].f01_NNA_G_CI,
          f01_NNA_G_CIUD_valor: $scope.grid_n[i].f01_NNA_G_CIUD_valor,
          f01_NNA_G_FEC_NAC: $scope.grid_n[i].f01_NNA_G_FEC_NAC,
          f01_NNA_G_GEN_valor: $scope.grid_n[i].f01_NNA_G_GEN_valor,
          f01_NNA_G_LUG_NAC_valor: $scope.grid_n[i].f01_NNA_G_LUG_NAC_valor,
          f01_NNA_G_NOM: $scope.grid_n[i].f01_NNA_G_NOM,
          f01_NNA_G_TELF: $scope.grid_n[i].f01_NNA_G_TELF,
          f01_NNA_TER_MACRO_valor: $scope.grid_n[i].f01_NNA_TER_MACRO_valor,
          f01_NNA_TER_MACRO: $scope.grid_n[i].f01_NNA_TER_MACRO,
          f01_NNA_TER_TEL: $scope.grid_n[i].f01_NNA_TER_TEL,
          f01_NNA_TER_ZONA: $scope.grid_n[i].f01_NNA_TER_ZONA,
          f01_NNA_TER_ZONA_DESC: $scope.grid_n[i].f01_NNA_TER_ZONA_DESC,
          oid: $scope.grid_n[i].oid,
          dtspsl_file_fotocopia_ci : $scope.grid_n[i].dtspsl_file_fotocopia_ci,
          dtspsl_file_fotocopia_ci_r : $scope.grid_n[i].dtspsl_file_fotocopia_ci_r,
          Url_certificado_nac: $scope.grid_n[i].Url_certificado_nac,
          Url_dni_anverso: $scope.grid_n[i].Url_dni_anverso,
          Url_dni_reverso: $scope.grid_n[i].Url_dni_reverso
        });*/
      }
      var titulosrep = [{
        "tipo": "GRD",
      ...
      for (var i = 0; i < $scope.grid_a.length; i++) {
        ...
        /*datos.TER_RESP.push({
          f01_ADUL_TIP_DOC_valor: $scope.grid_a[i].f01_ADUL_TIP_DOC_valor,
          f01_ADUL_DIR: $scope.grid_a[i].f01_ADUL_DIR,
          f01_ADUL_EXP_CIUD_valor: $scope.grid_a[i].f01_ADUL_EXP_CIUD_valor,
          f01_ADUL_EXP_CIUD: $scope.grid_a[i].f01_ADUL_EXP_CIUD,
          f01_ADUL_F_CADUC_CI: $scope.grid_a[i].f01_ADUL_F_CADUC_CI,
          f01_ADUL_G_AMAT: $scope.grid_a[i].f01_ADUL_G_AMAT,
          f01_ADUL_G_APAT: $scope.grid_a[i].f01_ADUL_G_APAT,
          f01_ADUL_G_CI: $scope.grid_a[i].f01_ADUL_G_CI,
          f01_ADUL_TER_CIUD_valor: $scope.grid_a[i].f01_ADUL_TER_CIUD_valor,
          f01_ADUL_G_FEC_NAC: $scope.grid_a[i].f01_ADUL_G_FEC_NAC,
          f01_ADUL_G_GEN_valor: $scope.grid_a[i].f01_ADUL_G_GEN_valor,
          f01_ADUL_LUG_NAC_valor: $scope.grid_a[i].f01_ADUL_LUG_NAC_valor,
          f01_ADUL_G_NOM: $scope.grid_a[i].f01_ADUL_G_NOM,
          f01_ADUL_G_TELF: $scope.grid_a[i].f01_ADUL_G_TELF,
          f01_ADUL_TER_MACRO_valor: $scope.grid_a[i].f01_ADUL_TER_MACRO_valor,
          f01_ADUL_TER_MACRO: $scope.grid_a[i].f01_ADUL_TER_MACRO,
          f01_ADUL_TER_TEL: $scope.grid_a[i].f01_ADUL_TER_TEL,
          f01_ADUL_TER_ZONA: $scope.grid_a[i].f01_ADUL_TER_ZONA,
          f01_ADUL_TER_ZONA_DESC: $scope.grid_a[i].f01_ADUL_TER_ZONA_DESC,
          oid: $scope.grid_a[i].oid,
          dtspsl_file_fotocopia_ci : $scope.grid_a[i].dtspsl_file_fotocopia_ci,
          dtspsl_file_fotocopia_ci_r : $scope.grid_a[i].dtspsl_file_fotocopia_ci_r,
          f01_ADUL_G_VA_valor : $scope.grid_a[i].f01_ADUL_G_VA_valor,
          f01_ADUL_G_PARE_COND_valor: $scope.grid_a[i].f01_ADUL_G_PARE_COND_valor,
          Url_dni_anverso: $scope.grid_a[i].Url_dni_anverso,
          Url_dni_reverso: $scope.grid_a[i].Url_dni_reverso
        });*/
      }
    ...
    $scope.buscarciudadano = function(ciciudadano,tipo){
               ...
               buscarRepresentante.buscarPersona(function(res){
                ...
                if (x.error) {
                  ...
                  if (x.length > 0) {
                    ...
                    /*var fecha2 = new Date(x[0].dtspsl_fec_nacimiento);
                    var anio_actual2   = fecha2.getFullYear();
                    $scope.cal_edad = anio_actual - anio_actual2;*/
                    ...
                    console.log("edad",$scope.cal_edad);
                    $.unblockUI();
                    if ($scope.cal_edad <= 17) {
                      ...
                      //swal("", 'Resultado Exitoso', "success");
                      //$scope.dit_zonas(x[0].dtspsl_macrodistrito);
                      ...
                      setTimeout(function(){
                        ...
                        $scope.mod.f01_NNA_TER_ZONA = x[0].dtspsl_zona;
                        //$scope.mod.f01_NNA_TER_ZONA = x[0].dtspsl_zona.trim()+"-"+$scope.des_zon.trim();
      ...
      $scope.guardarmod = function (campos) {
        ...
        for (var i = 0; i < $scope.grid_n.length; i++) {
          ...
          /*
          $scope.datos.TER_NNA_VIAJAN.push({
            f01_NNA_TIP_DOC_valor: $scope.grid_n[i].f01_NNA_TIP_DOC_valor,
            f01_NNA_DIR: $scope.grid_n[i].f01_NNA_DIR,
            f01_NNA_EXP_CIUD_valor: $scope.grid_n[i].f01_NNA_EXP_CIUD_valor,
            f01_NNA_EXP_CIUD: $scope.grid_n[i].f01_NNA_EXP_CIUD,
        ...
        $scope.muestra_cn_n = false;
          ...
          if (campos.f01_NNA_TIP_DOC_valor == "CI") {
            ...
            if (campos.oid=="" || campos.oid== undefined) {
              $scope.url_CI_Anverso = campos.dtspsl_file_fotocopia_ci;//CONFIG.APIURL + "/files/SCANNER/"+campos.f01_NNA_G_CI+"/"+campos.f01_NNA_G_CI+"_anverso.jpg"+"?app_name=todoangular";
            }else {
            ...
            if (campos.oid=="" || campos.oid== undefined) {
              $scope.url_CI_Reverso = campos.dtspsl_file_fotocopia_ci_r;//CONFIG.APIURL + "/files/SCANNER/"+campos.f01_NNA_G_CI+"/"+campos.f01_NNA_G_CI+"_reverso.jpg"+"?app_name=todoangular";
            }else {
...
////////////////////////////////////////// grilla adultos ////////////////////////////////////////////
                ...
                natural.buscarNatural(function(res){*/
                  ...
                  if (x.error) {
                    ...
                    if (x.length > 0) {
                      ...
                      var fecha2        = new Date(x[0].dtspsl_fec_nacimiento);
                      var anio_actual2   = fecha2.getFullYear();
                      $scope.cal_edadm = anio_actual - anio_actual2;*/
                      var fecnac = new Date(x[0].dtspsl_fec_nacimiento);
                      var mes = fecnac.getMonth() + 1;
                      var dia = fecnac.getDate()+1;
                      if(fecnac.getDate()<10){
                      ...
                      console.log("edad",$scope.cal_edad_mayor);
                      if ($scope.cal_edad_mayor >= 18) {
                        $scope.busquedaCiudadano = x[0];
                        try{
                          var zonas = new zonaLstM();
                        ...
                        if (x[0].dtspsl_file_fotocopia_ci=="") {
                          //$scope.url_CI_Anverso = CONFIG.APIURL + "/files/SCANNER/"+x[0]._id+"_anverso.jpg"+"?app_name=todoangular";
                          //$scope.url_CI_Anverso = CONFIG.APIURL + "/files/SCANNER/"+ciciudadano+"/"+ciciudadano+"_anverso.jpg"+"?app_name=todoangular";
                        }else {
                          $scope.url_CI_Anverso = CONFIG.APIURL + "/files/RC_CLI/"+x[0]._id+"/"+x[0].dtspsl_file_fotocopia_ci+"?app_name=todoangular";
                        }
    ...
    $scope.guardarmod_adultos = function (campos) {
      ...
      if ($scope.bandera_adultos == 0) {
        ...
        /*$scope.grid_a.push({
          f01_ADUL_TIP_DOC_valor: campos.f01_ADUL_TIP_DOC_valor,
          f01_ADUL_DIR: campos.f01_ADUL_DIR,
          f01_ADUL_EXP_CIUD_valor: campos.f01_ADUL_EXP_CIUD_valor,
          f01_ADUL_EXP_CIUD: campos.f01_ADUL_EXP_CIUD,
          f01_ADUL_F_CADUC_CI: campos.f01_ADUL_F_CADUC_CI,
          f01_ADUL_G_AMAT: campos.f01_ADUL_G_AMAT,
          f01_ADUL_G_APAT: campos.f01_ADUL_G_APAT,
          f01_ADUL_G_CI: campos.f01_ADUL_G_CI,
          f01_ADUL_TER_CIUD_valor: campos.f01_ADUL_TER_CIUD_valor,
          f01_ADUL_G_FEC_NAC: campos.f01_ADUL_G_FEC_NAC,
          f01_ADUL_G_GEN_valor: campos.f01_ADUL_G_GEN_valor,
          f01_ADUL_LUG_NAC_valor: campos.f01_ADUL_LUG_NAC_valor,
          f01_ADUL_G_NOM: campos.f01_ADUL_G_NOM,
          f01_ADUL_G_TELF: campos.f01_ADUL_G_TELF,
          f01_ADUL_TER_MACRO_valor: campos.f01_ADUL_TER_MACRO_valor,
          f01_ADUL_TER_MACRO: campos.f01_ADUL_TER_MACRO,
          f01_ADUL_TER_TEL: campos.f01_ADUL_TER_TEL,
          f01_ADUL_TER_ZONA: campos.f01_ADUL_TER_ZONA,
          f01_ADUL_TER_ZONA_DESC: campos.f01_ADUL_TER_ZONA_DESC,
          oid: campos.oid,
          dtspsl_file_fotocopia_ci : campos.dtspsl_file_fotocopia_ci,
          dtspsl_file_fotocopia_ci_r : campos.dtspsl_file_fotocopia_ci_r,
          f01_ADUL_G_VA_valor : campos.f01_ADUL_G_VA_valor,
          f01_ADUL_G_PARE_COND_valor: campos.f01_ADUL_G_PARE_COND_valor,
          Url_dni_anverso: campos.Url_dni_anverso,
          Url_dni_reverso: campos.Url_dni_reverso
        });*/
        var titulosrep = [{
    ...
    $scope.edit_grid_adultos = function(idx,campos_adultos){
      $scope.url_CI_Anverso = "";
      $scope.url_CI_Reverso = "";
      console.log("idx,campos_adultos",idx,campos_adultos);
        /*
        cadena = campos.dtspsl_file_fotocopia_ci;
        if(cadena.indexOf('http') != -1){
        */
        if (campos_adultos.f01_ADUL_TIP_DOC_valor == "DN") {
          ...
          $scope.url_Dni_anverso = campos_adultos.Url_dni_anverso;;//CONFIG.APIURL + "/files/SCANNER/"+campos_adultos.f01_ADUL_G_CI+"/"+campos_adultos.f01_ADUL_G_CI+"_dni_anverso.jpg"+"?app_name=todoangular";
          $scope.url_Dni_reverso = campos_adultos.Url_dni_reverso;;//CONFIG.APIURL + "/files/SCANNER/"+campos_adultos.f01_ADUL_G_CI+"/"+campos_adultos.f01_ADUL_G_CI+"_dni_reverso.jpg"+"?app_name=todoangular";
        }
    ...
    $scope.ejecutarFile = function(idfile,data_modal,tipo_img,verificador){
        ...
        console.log("$scope.validador_img",$scope.validador_img,"$scope.validador_img");
    ...
    $scope.almacenarRequisitos = function(aArchivos){
      console.log("aArchivos.............----------------",$scope.validador_img);
        ...
        /*"http://192.168.6.57:90/rest/files/SCANNER/"++"/"+identificador+".jpg?app_name=todoangular"
        "http://192.168.5.141/rest/files/SCANNER/151790/151790_ci_nacimiento.jpg?app_name=todoangular"*/
        console.log("aArchivos[0], uploadUrl",aArchivos[0], uploadUrl);
