...
function AsBuiltController($scope, $rootScope, $routeParams, $location, $http, Data, sessionService,CONFIG, LogGuardarInfo, $element, sweet, ngTableParams, $filter, registroLog, filterFilter,FileUploader, fileUpload, obtFechaActual,wsRgistrarPubliciadad,$timeout,$window)
{
    ...
    $scope.accionDescargarSolicitud = function (sol) {
        //console.log("entro $scope.accionDescargarSolicitud");
    ...
    $scope.accionImprimirProforma = function (sol, idDocumento) {
        //console.log("entro $scope.accionImprimirProforma");
        $scope.varSpin = true;
        $scope.RegistroFUM={
            registrado:'OK',
            mensaje:''
    ...
    $scope.setSolicitudParametrosEdificacion = function (sol) {
        //console.log("entro $scope.setSolicitudParametrosEdificacion");
    ...
    $scope.getSolicitud = function (idFichaTecnica) {
        //console.log("entro $scope.getSolicitud");
